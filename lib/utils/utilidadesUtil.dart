...
class UtilidadesUtil {
  ...
  static pantallasAbrirNuevaCerrarTodas(
      {BuildContext context, String pantalla}) {
    Navigator.of(context)
        .pushNamedAndRemoveUntil(pantalla, (Route<dynamic> route) => false);
  }

  static pantallasAbrirNuevaCerrarTodasWidget(
      {BuildContext context, Route pantalla}) {
    Navigator.of(context)
        .pushAndRemoveUntil(pantalla, (Route<dynamic> route) => false);
  }

  static Future<GaleryCameraModel> getImagenResourse(
      {String title, imageFile}) async {
