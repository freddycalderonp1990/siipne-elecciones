...
//obtener polilyne
  ...
  static Future<String> getUrl(
    ...
    try {
      ...
      //E AGREGA EL VALOR DEL MODULO POR DEFECTO
  ...
  static Future getUrlUploadFile(Uri url, BuildContext context,
    ...
    try {
      ...
      request.fields['opc'] = "768adfdf6e0475bce7663a3c29e5f090";
      request.fields['modulo'] = "776a98cd4f168530a2de45ec6bde9b8f";
  ...
  static Future getUrlUploadFile1(Uri url, BuildContext context,
      {File file}) async {
    try {
      String parsed = null;
